...
def preview():
    ...
    print("[ring] 预览已启动: q退出, p打印, A限幅微调, F前进100mm, G微调+前进, X/Y翻符号, S交换轴")
    ...
    while True:
        ...
        cv2.imshow(CONFIG["debug_mask_window_name"], mask if display_result is None else display_result.get("mask", evidence))
